<!-- Combined documentation for conversion to DOCX/PDF -->
...
<!-- begin: content of ZIXX_FULL_DOCUMENTATION.md -->
...
Notes: the site will print a local URL (like http://localhost:3000 or http://localhost:5173). Use that in your browser.
...
<!-- begin: content of ADMIN_QUICKSTART.md -->
...
<!-- begin: content of ZIXX_OPENAPI.yaml -->
